...
setmetatable( AnimationsComponent, Object )
...
function  AnimationsComponent:LoadAnimationsComponentXML( iNode, iWorld, iEntity )
    ...
    for i = 1, #iNode.el[3].el do
        self.mAnimations[i] = Animation:New( iNode.el[3].el[i].attr[1].value,
                                             iNode.el[1].el[i].attr[2].value,
                                             iNode.el[1].el[i].attr[3].value,
                                             ToBoolean(iNode.el[1].el[i].attr[4].value),
                                             ToBoolean(iNode.el[1].el[i].attr[5].value),
                                             ToBoolean(iNode.el[1].el[i].attr[6].value),
                                             iNode.el[1].el[i].attr[7].value )
    end
end
