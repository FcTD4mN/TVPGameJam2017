...
function MovingPlatform:New( iWorld, iX, iY, iW, iH )
    ...
    path["points"][3] = {}
    path["points"][3]["body"] = love.physics.newBody( iWorld, iX + 400, iY, "static" )
    path["points"][3]["x"] = iX + 400
    path["points"][3]["y"] = iY
    path["points"][3]["time"] = 3
    path["points"][4] = {}
    path["points"][4]["body"] = love.physics.newBody( iWorld, iX +400, iY, "static" )
    path["points"][4]["x"] = iX + 400
    path["points"][4]["y"] = iY
