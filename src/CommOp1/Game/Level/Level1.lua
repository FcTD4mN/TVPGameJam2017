...
function Level1:InitializeNodePath()
    ...
    table.insert( gConnections,  Connection:New( gNodeF,      gNodeG,         dstFG      ) )
    table.insert( gConnections,  Connection:New( gNodeF,      gNodeH,         dstFH      ) )
    table.insert( gConnections,  Connection:New( gNodeH,      gNodeI,         dstHI      ) )
    table.insert( gConnections,  Connection:New( gNodeH,      gNodeJ,         dstHJ      ) )
    table.insert( gConnections,  Connection:New( gNodeJ,      gNodeK,         dstJK      ) )
    table.insert( gConnections,  Connection:New( gNodeJ,      gNodeL,         dstJL      ) )
    table.insert( gConnections,  Connection:New( gNodeL,      gNodeM,         dstLM      ) )
